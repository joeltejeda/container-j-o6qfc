...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-j-o6qfc.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-j-o6qfc.containers.anotherwebservice.com/
...
```
git clone git@github.com:joeltejeda/container-j-o6qfc.git
cd container-j-o6qfc
```
...
```
docker attach container-j-o6qfc
```
